...
<script>
import FavoriteIcon from "@/components/Heart.vue";
export default {
  name: "ToggleFavorite",
  components: {
    FavoriteIcon
...
.favorite-particles-transition-enter-active {
  background-image: url("https://uploads.codesandbox.io/uploads/user/5920804a-c1dc-40c1-bfec-af8321f3d7d5/v7bn-particles-animation.png");
